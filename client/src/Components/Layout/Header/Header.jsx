  ...
  render() {
      ...
      >
        ...
        {this.props.auth.user.admin
          ?
            ...
            <MenuItem onClick={this.handleMenuClose}>Admin panel</MenuItem>
            </Link>
          :
            null
        }
        ...
        <MenuItem onClick={this.MenuClose}>Log Out</MenuItem>
      </Menu>
    );
    ...
    return (
      <div className={classes.root}>
        <AppBar style={{backgroundColor: 'rgb(0, 22, 53)'}} position="fixed">
          <Toolbar>    
            <Drawer />
